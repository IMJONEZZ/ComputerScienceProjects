  ...
  def explore(self):
    ...
    while current_room != 'treasure room':
      ...
      if choice not in valid_choices:
        print(f"Please select from these letters: {valid_choice}")
      else:
...
def build_graph():
  ...
  entrance.add_edge(ante_chamber.value, 7)
  entrance.add_edge(kings_room.value, 3)
  ante_chamber.add_edge(entrance.value, 7)
  kings_room.add_edge(entrance.value, 3)
  kings_room.add_edge(ante_chamber.value, 1)
  ante_chamber.add_edge(kings_room.value, 1)
  grand_gallery.add_edge(ante_chamber.value, 2)
  grand_gallery.add_edge(kings_room.value, 2)
  ante_chamber.add_edge(grand_gallery.value, 2)
  kings_room.add_edge(grand_gallery.value, 2)
  treasure_room.add_edge(ante_chamber.value, 6)
  treasure_room.add_edge(grand_gallery.value, 4)
  ante_chamber.add_edge(treasure_room.value, 6)
  grand_gallery.add_edge(treasure_room.value, 4)
